...
namespace KindHelp.Web.Migrations
{
    ...
    [Migration("20260610065354_AddWalletCorrection")]
    partial class AddWalletCorrection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KindHelp.Web.Models.Donor", b =>
                {
                    ...
                    b.ToTable("Donors", t =>
                        {
                            t.HasCheckConstraint("CK_Donors_PhoneNormalized", "\"PhoneNumber\" IS NULL OR \"PhoneNumber\" ~ '^\\+?[0-9]+$'");
                        });
                });
            ...
            modelBuilder.Entity("KindHelp.Web.Models.WalletTransaction", b =>
                {
                    ...
                    b.Property<int?>("CorrectsWalletTransactionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CorrectsWalletTransactionId");
            ...
            modelBuilder.Entity("KindHelp.Web.Models.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("KindHelp.Web.Models.WalletTransaction", "CorrectsWalletTransaction")
                        .WithMany()
                        .HasForeignKey("CorrectsWalletTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CorrectsWalletTransaction");
