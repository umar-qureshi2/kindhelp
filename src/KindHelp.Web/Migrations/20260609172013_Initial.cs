        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PublishedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ClosedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    BeneficiaryName = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ShowBeneficiaryName = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CasePhotos_CaseId_SortOrder",
                table: "CasePhotos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseUpdates_CaseId_PostedAtUtc",
                table: "CaseUpdates",
                columns: new[] { "CaseId", "PostedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Contributions_CaseId_ReceivedAtUtc",
                table: "Contributions",
